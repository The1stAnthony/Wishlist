...
// Strip ?sslmode=... from the URL — newer pg versions treat 'require' as
// 'verify-full' (full cert chain check), which fails on Supabase's intermediate
// cert. We handle SSL explicitly via the ssl option instead.
